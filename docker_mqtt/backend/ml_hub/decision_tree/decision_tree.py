...
import logging 
import datetime
logging.basicConfig(filename='logs/decisionTree.log', level=logging.DEBUG)
script_name = 'decision-tree'
############################################################################
...
def main():
	...
	logging.debug('{} - ({}) : DT model training'.format(script_name,str(datetime.datetime.now())))
	#print("------------------      DT model      -------------------- ")
